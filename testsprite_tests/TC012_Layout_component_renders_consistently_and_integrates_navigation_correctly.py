...
async def run_test():
    ...
    try:
        ...
        # Click 'Começar Agora' button to navigate to next page to check Layout wrapping
        elem = frame.locator('xpath=html/body/div/div/div/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click 'Começar Agora' button to navigate to the next page and verify Layout wrapping and UI elements presence
        frame = context.pages[-1]
        # Click 'Começar Agora' button to navigate to next page
        elem = frame.locator('xpath=html/body/div/div/div/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
